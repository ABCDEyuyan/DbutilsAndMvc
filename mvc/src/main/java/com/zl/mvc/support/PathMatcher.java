 ...
 * 用来解析当前请求用哪一个Handler去处理(见{@link com.zl.mvc.mapping.RequestMappingHandlerMapping#getHandler(HttpServletRequest)})
 * 以及拦截器时候要应用到当前请求上(见:{@link com.zl.mvc.mapping.RequestMappingHandlerMapping#getInterceptors(HttpServletRequest)})
 * @see AntPathMatcher
 * @see EqualPathMatcher
 * @see EqualIgnoreCasePathMatcher
 * @see com.zl.mvc.mapping.RequestMappingHandlerMapping
 */
