 ...
 *     <li>返回其它类型，这种情况比较少见(不建议)，框架直接把其适配为返回{@link com.zl.mvc.view.PlainViewResult}</li>
 * </ul>
 ...
 * </p>
 * @author cj
 * @see com.zl.mvc.view.PlainViewResult
 * @see com.zl.mvc.ViewResult
 * @see com.zl.mvc.adapter.RequestMappingHandlerAdapter
