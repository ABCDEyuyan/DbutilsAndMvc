...
import com.zl.mvc.view.PlainViewResult;
import com.zl.mvc.view.VoidViewResult;
 ...
 * 比如用户返回一个{@link com.zl.mvc.view.JsonViewResult},那么就会响应一个json数据给用户。
 * 用户代码中不需要直接实例化某一个具体的ViewResult子类实例，可以借助于{@link com.zl.mvc.handler.HandlerHelper}
 * 类中的静态方法，常见代码如下
 * <pre class="code">
 *   &#064;RequestMapping("/json")
 ...
 *   }
 * </pre>
 * @see com.zl.mvc.view.JsonViewResult
 * @see PlainViewResult
 * @see com.zl.mvc.view.ForwardViewResult
 * @see com.zl.mvc.view.RedirectViewResult
 * @see com.zl.mvc.view.HtmlViewResult
 * @see VoidViewResult
 */
